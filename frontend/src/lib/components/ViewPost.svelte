    ...
    {:then p}
        ...
        {:then c}
            <div class="flex flex-col">
                ...
                <div>
                    <!-- heroicons/thumb-up -->
                    <svg class="inline-block h-8 w-8 align-middle rounded-full bg-green-600" fill="none"
                ...
                <div>
                    ...
                    <svg class="inline-block h-8 w-8 align-middle rounded-full bg-red-600" fill="none"
                         stroke="currentColor"
